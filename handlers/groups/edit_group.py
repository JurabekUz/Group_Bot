...
from filters.adminfl import Adminfillter

@dp.message_handler(IsGroup(), Command("set_photo", prefixes="!/"), Adminfillter())
...
@dp.message_handler(IsGroup(), Command("set_title", prefixes="!/"), Adminfillter())
...
@dp.message_handler(IsGroup(), Command("set_description", prefixes="!/"), Adminfillter())
