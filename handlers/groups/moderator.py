...
from filters import IsGroup, Adminfillter
...
@dp.message_handler(IsGroup(), Command("ro", prefixes="!/"), Adminfillter())
...
@dp.message_handler(IsGroup(), Command("unro", prefixes="!/"), Adminfillter())
...
@dp.message_handler(IsGroup(), Command("ban", prefixes="!/"), Adminfillter())
...
@dp.message_handler(IsGroup(), Command("unban", prefixes="!/"), Adminfillter())
